        ...
        <div className="max-w-4xl mx-auto px-4 lg:px-8 text-right">
          <div className="prose prose-lg max-w-none text-gray-600 font-medium leading-relaxed space-y-8">
            ...
            <div>
              ...
              <p>
                نحن في شركة هوت لاين انترناشيونال للشحن والتفريغ والخدمات الملاحية نلتزم بحماية خصوصية بيانات عملائنا وزوار موقعنا الإلكتروني. توضح سياسة الخصوصية هذه كيفية جمع واستخدام وحماية البيانات التي تزودنا بها أثناء تصفح الموقع أو طلب الخدمات.
              </p>
            </div>
