      ...
      <section className="py-20 lg:py-32 relative overflow-hidden bg-primary text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 relative z-10 text-center lg:text-right">
          ...
          <p className="text-xl text-gray-300 font-medium leading-relaxed max-w-3xl">
            شركة هوت لاين انترناشيونال للشحن والتفريغ والخدمات الملاحية شركة متخصصة في تقديم حلول الشحن والنقل والخدمات اللوجستية المتكاملة على المستويين الإقليمي والدولي. نعمل على ربط الأسواق والموانئ والموردين والعملاء من خلال منظومة تشغيلية احترافية تضمن سهولة الحركة التجارية وسرعة الإنجاز وتقليل التحديات التشغيلية التي تواجه العملاء. لقد مكنتنا خبرتنا الطويلة من خدمة العديد من القطاعات التجارية والصناعية، وتقديم حلول مرنة تتناسب مع مختلف أنواع الشحنات والبضائع مهما كانت طبيعتها أو وجهتها.
          </p>
        </div>
      </section>
